...
RULES = {
    ...
    "RejectRule": {
        ...
        "MyAdblock": "https://raw.githubusercontent.com/Ananaskop/Profile/main/QuantumultX/Rule/MyAdblock.list",
    ...
    "DirectRule": {
        ...
        "Speedtest": "https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Speedtest/Speedtest.list",
    ...
    "USRule": {
        ...
        "Anthropic": "https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Anthropic/Anthropic.list",
        ...
        for file_name in os.listdir(path):
            ...
            if os.path.isfile(file_path):
                with open(file_path, 'r', encoding='utf8') as in_f:
                    lines = [line.strip() for line in in_f.readlines() if not (line.startswith("#") or line.startswith("USER-AGENT") or line.startswith(";"))]
